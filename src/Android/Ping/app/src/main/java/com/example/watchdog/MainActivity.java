...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Video newVideo1 = new Video("https://storage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4", "2023-05-18");
        Video newVideo2 = new Video("https://storage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4", "2023-05-18");

        // Add the new video entry to the dataset
        videoList.add(newVideo1);
